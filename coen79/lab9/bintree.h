...
namespace coen79_lab9
{
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            // STUDENT WORK
            //recursive calls to iterate through tree inorder
    ...
    {
        // STUDENT WORK
        //recursive calls to iterate through tree postorder
    ...
    {
        // STUDENT WORK
        //recursive calls to iterate through tree preorder
        f(node_ptr -> data());
    ...
    // Library facilities used: cstdlib
    {
        ...
        if (root_ptr != NULL)
        {
            ...
            tree_clear( child );
            // STUDENT WORK
            //establlishes child is to the right of root, recursive call to clear the child, then delete root pointer and set it to NULL
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            // STUDENT WORK
            //copies left and right subtrees then connects to root ptr
    ...
    // Library facilities used: cstdlib
    {
        if (node_ptr == NULL)
            ...
            // STUDENT WORK
            //adds both sides of binary search tree
